...
class GaussianModel:
    ...
    def training_setup(self, training_args):
        ...
        if training_args.include_feature:
            ...
            l = [
                ...
                {'params': [self._rotation], 'lr': training_args.rotation_lr, "name": "rotation"},# TODO: training_args.language_feature_lr
            ]
    ...
    def prune_points(self, mask):
        ...
        self._opacity = optimizable_tensors["opacity"]
        self._language_feature = optimizable_tensors["language_feature"] ##NOT
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation):
        ...
        "language_feature": new_language_feature, ##NOT
        "scaling" : new_scaling,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        new_language_feature = self._language_feature[selected_pts_mask].repeat(N,1) ##NOT
